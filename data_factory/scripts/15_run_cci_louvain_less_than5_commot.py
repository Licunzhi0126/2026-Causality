...
def main() -> None:
    parser = build_argparser(
        description="Run official COMMOT CCI on Louvain less-than-5 domain h5ad files.",
        default_input=FACTORY_OUTPUT_ROOT / "louvain_less_than5",
        default_output=FACTORY_OUTPUT_ROOT / "cci" / "louvain_less_than5",
        unit_kind="domain",
    )
    ...
    run_commot_layer(
        ...
        manifest_name="cci_manifest_louvain_less_than5.csv",
