...
DOMAIN_LAYER_SPECS: Dict[str, DomainLayerSpec] = {
    ...
    "pash_mrc_k40": DomainLayerSpec(
        name="pash_mrc_k40",
        family="pash_mrc",
        output_name="pash_mrc_k40",
        sample_prefix="pashMRC40",
        domain_manifest="domain_manifest_pash_mrc_k40.csv",
        grn_manifest="grn_manifest_pash_mrc_k40.csv",
        cci_manifest="cci_manifest_pash_mrc_k40.csv",
        mode="exact_k",
        k=40,
    ),
    "pash_mrc_k150": DomainLayerSpec(
        name="pash_mrc_k150",
        family="pash_mrc",
        output_name="pash_mrc_k150",
        sample_prefix="pashMRC150",
        domain_manifest="domain_manifest_pash_mrc_k150.csv",
        grn_manifest="grn_manifest_pash_mrc_k150.csv",
        cci_manifest="cci_manifest_pash_mrc_k150.csv",
        mode="exact_k",
        k=150,
    ),
