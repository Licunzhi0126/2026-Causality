...
from mignet_ce.pij.compare.compare_NR_fgw_regsim_v9 import (
    regsim_v9_pij_numpy,
    regsim_v9_pij_torch,
)
...
def prepare(request: CoarseFrontendRequest) -> PreparedCoarseInput:
    ...
    _, micro_pij, _, pij_metadata = regsim_v9_pij_numpy(
        n_t,
        n_tp,
        r_t,
        r_tp,
    ...
    prepared = PreparedCoarseInput(
        ...
        provenance={
            **provenance_base(request, pair),
            ...
            "pij": "RegSim_V9_directed_lowrank_FGW",
