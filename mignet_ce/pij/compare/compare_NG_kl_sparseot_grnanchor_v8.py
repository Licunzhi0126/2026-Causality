...
class CompareNGKlSparseOTGRNAnchorV8PijMethod:
    """Frozen V5 cost followed by state-normalized sparse balanced OT."""

    name = "compare_NG_kl_sparseot_grnanchor_v8"
    feature_keys = ("N",)
    pij_key = "kl"
        ...
        metadata.update(
            {
                ...
                "algorithm_version": "lightcci_grn_sparseot_grnanchor_v8",
                ...
                "fixed_transport_scale": FIXED_KERNEL_TEMPERATURE,
            }
        )
    ...
    def _build_pair_kernel(
        ...
        *,
        ...
        joint, sparse_pij, sparse_ot_metadata = solve_state_normalized_quadratic_balanced_ot(cost)
        diagnostics = {
            "kind": "state_normalized_sparse_balanced_ot_grnanchored_block_kl",
            "beta": FIXED_FEATURE_BETA,
            "transport_scale": FIXED_KERNEL_TEMPERATURE,
            "cost": matrix_summary(cost),
            "sparse_joint": matrix_summary(joint),
            "sparse_pij": matrix_summary(sparse_pij),
            "sparse_ot": sparse_ot_metadata,
            "main_cost_dense": cost,
            "block_kl": block_metadata,
        }
        return sp.csr_matrix(joint), sp.csr_matrix(sparse_pij), sparse_pij, diagnostics
    ...
    def run(
        ...
        kernels = TransitionKernels(
            kernel_metadata={
                ...
                "fusion_mode": "frozen_v5_cost_state_normalized_sparse_ot",
                "transition_construction": "state_normalized_sparse_balanced_ot_grnanchored_block_kl",
                ...
                "quadratic_ot_max_iterations": DEFAULT_MAX_ITERATIONS,
                "quadratic_ot_marginal_tolerance": DEFAULT_MARGINAL_TOLERANCE,
                "quadratic_regularization_rule": "min(n_source,n_target)",
                ...
                "parameter_selection_split": "fixed_formula_no_EI_selection",
        ...
        for pair in pairs:
            ...
            for side, target_dict in (("lower", kernels.p_lower), ("upper", kernels.p_upper)):
                ...
                sparse_ot_metadata = diagnostics["sparse_ot"]
                kernels.kernel_metadata[pair_label][side] = {
                    ...
                    "cost_is_exact_frozen_v5_formula": True,
                    "sparse_ot": sparse_ot_metadata,
                    "raw_matrix_semantics": "sparse_balanced_joint_coupling",
        ...
        result = MethodResult(
            ...
            method_metadata={
                "pij_method": self.name,
                "representation": "lightcci_grn_sparseot_grnanchor_v8",
                "compare_feature_keys": list(self.feature_keys),
                "compare_pij_method": self.pij_key,
                "fusion_mode": "frozen_v5_cost_state_normalized_sparse_ot",
                "transition_construction": "state_normalized_sparse_balanced_ot_grnanchored_block_kl",
