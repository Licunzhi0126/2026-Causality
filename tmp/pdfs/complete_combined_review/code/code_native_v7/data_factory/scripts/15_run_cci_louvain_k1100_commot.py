...
def main() -> None:
    parser = build_argparser(
        description="Run official COMMOT CCI on Louvain K1100 domain h5ad files.",
        default_input=FACTORY_OUTPUT_ROOT / "louvain_k1100",
        default_output=FACTORY_OUTPUT_ROOT / "cci" / "louvain_k1100",
        unit_kind="domain",
    )
    ...
    run_commot_layer(
        ...
        manifest_name="cci_manifest_louvain_k1100.csv",
