...
def main() -> None:
    parser = build_argparser(
        description="Run official COMMOT CCI on Seurat K40 domain h5ad files.",
        default_input=FACTORY_OUTPUT_ROOT / "seurat_k40",
        default_output=FACTORY_OUTPUT_ROOT / "cci" / "seurat_k40",
        unit_kind="domain",
    )
    ...
    run_commot_layer(
        ...
        manifest_name="cci_manifest_seurat_k40.csv",
